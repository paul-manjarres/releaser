...
import com.releaser.ReleaserApp;
import com.releaser.config.AsyncSyncConfiguration;
import com.releaser.config.EmbeddedSQL;
...
@SpringBootTest(classes = { ReleaserApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
